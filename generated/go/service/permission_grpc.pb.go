...
type PermissionServiceClient interface {
	...
	GetPlayerRoles(ctx context.Context, in *model.PlayerRequest, opts ...grpc.CallOption) (*PlayerRolesResponse, error)
...
func (c *permissionServiceClient) GetRoles(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RolesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/service.permission.PermissionService/GetRoles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *permissionServiceClient) GetPlayerRoles(ctx context.Context, in *model.PlayerRequest, opts ...grpc.CallOption) (*PlayerRolesResponse, error) {
	out := new(PlayerRolesResponse)
	err := c.cc.Invoke(ctx, "/service.permission.PermissionService/GetPlayerRoles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *permissionServiceClient) CreateRole(ctx context.Context, in *RoleCreateRequest, opts ...grpc.CallOption) (*RoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/service.permission.PermissionService/CreateRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *permissionServiceClient) UpdateRole(ctx context.Context, in *RoleUpdateRequest, opts ...grpc.CallOption) (*RoleResponse, error) {
	out := new(RoleResponse)
	err := c.cc.Invoke(ctx, "/service.permission.PermissionService/UpdateRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *permissionServiceClient) AddRoleToPlayer(ctx context.Context, in *AddRoleToPlayerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/service.permission.PermissionService/AddRoleToPlayer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *permissionServiceClient) RemoveRoleFromPlayer(ctx context.Context, in *RemoveRoleFromPlayerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/service.permission.PermissionService/RemoveRoleFromPlayer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PermissionServiceServer interface {
	...
	GetPlayerRoles(context.Context, *model.PlayerRequest) (*PlayerRolesResponse, error)
...
func (UnimplementedPermissionServiceServer) GetPlayerRoles(context.Context, *model.PlayerRequest) (*PlayerRolesResponse, error) {
...
func _PermissionService_GetRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.permission.PermissionService/GetRoles",
	}
...
func _PermissionService_GetPlayerRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.permission.PermissionService/GetPlayerRoles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).GetPlayerRoles(ctx, req.(*model.PlayerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PermissionService_CreateRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.permission.PermissionService/CreateRole",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PermissionService_UpdateRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.permission.PermissionService/UpdateRole",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PermissionService_AddRoleToPlayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.permission.PermissionService/AddRoleToPlayer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PermissionService_RemoveRoleFromPlayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.permission.PermissionService/RemoveRoleFromPlayer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.permission.PermissionService",
	...
	Metadata: "service/permission.proto",
}
